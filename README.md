...
- 🌐 **Full portfolio & book a meeting:** [muhammadaamirgulzar.github.io](https://muhammadaamirgulzar.github.io/)
...
| **[Urdu AI Video Creator](https://github.com/MuhammadAamirGulzar/urdu-ai-video-creator)** | Full-stack generative video · voice cloning + lip-sync | Wav2Lip · XTTS v2 · Next.js · FastAPI |
...
![Transformers](https://img.shields.io/badge/Transformers-FFD21E?style=flat&logoColor=black)
...
```text
Agentic AI & RAG      →  LangGraph, multi-agent orchestration, agentic RAG, evaluation (Ragas/DeepEval)
Voice & Multimodal    →  real-time ASR/TTS, WebRTC pipelines, VLMs, generative media
LLM Engineering       →  fine-tuning (LoRA/QLoRA), quantization, on-device/edge inference
AI Research           →  computational pathology, spatial transcriptomics, foundation models
```
